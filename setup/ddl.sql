...
INSERT INTO Player (teamID, firstName, lastName, positionID) VALUES
    (1, "Terry", "Jones", "L"),
    (1, "Volley", "Ball", "S"),
    (1, "Mr", "Setterman", "S"),
    (1, "Balley", "Voll", "OH"),
...
INSERT INTO Account (userID, userPassword, userEmail, roleID) VALUES
    ("player", "iAmPlayer!", "brzee@csu.fullerton.edu", "Player"),
    ("coach", "iAmCoach!", "brzee@csu.fullerton.edu", "Coach"),
    ("manager", "iAmManager!", 'brzee@csu,fullerton.edu', "Manager");

INSERT INTO Staff (teamID, firstName, lastName, staffRole) VALUES
    (1, "Mister", "Manager", "manager"),
    (1, "Coach", "Coachington", "coach");